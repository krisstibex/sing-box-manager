...
echo.
echo          _                   __              
echo    _____(_)___  ____ _      / /_  ____  _  __
echo   / ___/ / __ \/ __ `/_____/ __ \/ __ \| |/_/
echo  (__  ) / / / / /_/ /_____/ /_/ / /_/ />  <  
echo /____/_/_/ /_/\__, /     /_.___/\____/_/|_|  
echo              /____/                          
echo                                                
echo    ____ ___  ____ _____  ____ _____ ____  _____
echo   / __ `__ \/ __ `/ __ \/ __ `/ __ `/ _ \/ ___/
echo  / / / / / / /_/ / / / / /_/ / /_/ /  __/ /    
echo /_/ /_/ /_/\__,_/_/ /_/\__,_/\__, /\___/_/     
echo                             /____/             
echo.
echo ==============================================
echo.
